...
There have been  13 strings translated of the 8467 strings in the Magento source.
...
composer require magento2translations/language_hi_in:2.1.8.x-dev
php bin/magento cache:clean
```
## Manually
To install this language package manually you need access to your server file system.
* Download the zip file [here](https://github.com/Magento2Translations/language_hi_in/archive/2.1.8.zip).
